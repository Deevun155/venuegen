...
- This version supports [lighting (intro)], found at the bottom of the automatic lighting, next to BONUSFX to keep backward compatability. It behaves like [this](https://youtu.be/-T2UBHeshak). Please update your templates to use the new LIGHTING.txt.
